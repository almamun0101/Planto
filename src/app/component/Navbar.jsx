  ...
  return (
    <div>
      <div className="container">
        <nav className="flex p-5 lg:p-5 text-white/80 items-center justify-between z-50">
          ...
          {isOpen && (
            <ul ref={menuRef} className="flex w-full flex-col left-0 pl-10 gap-6 absolute top-20 borde bg-green-600  lg:hidden z-100">
